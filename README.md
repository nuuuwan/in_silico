...
The intended learner is an experienced programmer and computer scientist who is new to biology and pharmacology. The project therefore emphasizes biological concepts, scientific terminology, experimental evidence, and the assumptions behind computational methods rather than general programming instruction.
